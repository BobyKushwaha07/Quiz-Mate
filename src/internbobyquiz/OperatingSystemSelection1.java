...
import static internbobyquiz.OS.os;
import static internbobyquiz.OS.oschoice;
import static internbobyquiz.OS.osanswer;
 ...
 * @author boby
 */
public class OperatingSystemSelection1 extends javax.swing.JFrame {
    int count1=0;
    int countos=0;
    ...
    public OperatingSystemSelection1() {
        initComponents();
     ...
     public void os1(int l) {
            
       lbl_Question.setText(os[l]);
       
           rdbtn1.setText(oschoice[l][0]);
           rdbtn2.setText(oschoice[l][1]);
           rdbtn3.setText(oschoice[l][2]);
           rdbtn4.setText(oschoice[l][3]);
          String uans="";
     ...
     if(rdbtn4.isSelected())
     {
      uans="D";
           ...
           if(uans.equals(osanswer[l]))
                  {
               countos++;
               JOptionPane.showMessageDialog(this,"answer is correct ");
           } 
           
           else if(rdbtn1.isSelected() && rdbtn1.getText() != (osanswer[l])
                   || rdbtn2.isSelected() && rdbtn2.getText() != (osanswer[l])
                   || rdbtn3.isSelected() && rdbtn3.getText() != (osanswer[l])
                   || rdbtn4.isSelected() && rdbtn4.getText() != (osanswer[l])){
    ...
    private void btn_NEXTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_NEXTActionPerformed
        ...
        {
             JOptionPane.showMessageDialog(this," Test is over " + " " + " Your Marks Is :" + countos + "/10");
             SubjectSelection ss = new SubjectSelection();
             ss.setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OperatingSystemSelection1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OperatingSystemSelection1().setVisible(true);
            }
        });
    }
