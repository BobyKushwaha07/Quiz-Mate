...
static String oops[]={" Following is not a correct statement for preprocessor directive declaration?",
...
" Which of the following are valid array declaration",
" C++ supports â€¦.",
" char * const ptr1 = â€œniceâ€�;",
" int const *ptr1 = &m;",
" In the following statement,\n const char * const cp = â€œxyzâ€�;",
...
static String oopschoice[][]={
{"#include<iostream.h>",
" #include<iostream.h> #define LEFT 1",
" #define LEFT 1",
" #define ABS(a) (a)<0 ? â€“(a) : (a)"},
...
static String oopsanswer[]={"B","A","B","A","C","B","A","B","D","B","A","D","A","B","C","C","A","A","D","A","B","A","A","D","B","C","C","D","C","B","C","A","C","A","A","C","D","C","B","C"};
