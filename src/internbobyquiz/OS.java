...
static String os[]={"Round Robin scheduling is essentially the preemptive version of -",
...
static String osanswer[]={"A","B","B","A","A","D","C","D","B","C","A",
    "B","C","D","B","D","D","B","B","C","A","A","A","C","B","B","C","A",
    "D","A","A","C","B","C","D","D","B","B","D","D"};
  


/*static String osanswer[]={"First In First Out","Bounded weight","The page is in main memory",
    "FIFO","fork","allows processes to synchronize activity","loader","All of the above","Real time OS",
    "both (a) and (b)","parsing",
    "Throughput","Demand paging","Magnetic disk","Process Control Block","6","All","order in which disk access requests must be serviced",
    "SJF","mutual exclusion","FCFS","put tasks in I/O wait","Operation code","there is no need for an address i.e. the data is used as an address",
    "1","linking loader","a program in execution","defines the fundamental method of determining effective operand addresses",
    "contains a copy of the designated memory location specified by the MAR after a \"read\" or the new contents of the memory prior to a \"write\".",
    "preemptive scheduling","have both their operands in the main store.",
    "which perform indicated operations on two fast registers of the machine and have the result in one of the registers",
    "pages out pages that have not been used recently","Networking software","None of the above",
    "only allowed to the operating system","0","compaction does not involve relocation of programs",
    "allows processes to synchronize activity","All of the above"}; 
