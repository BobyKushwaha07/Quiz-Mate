...
import static internbobyquiz.DBMS.dbms;
import static internbobyquiz.DBMS.dbmschoice;
import static internbobyquiz.DBMS.dbmsanswer;
...
public class DataBaseSelection extends javax.swing.JFrame {
    ...
    public DataBaseSelection() {
     ...
     public void dbms1(int l) {
            
       lbl_Question.setText(dbms[l]);
       
           rdbtn1.setText(dbmschoice[l][0]);
           rdbtn2.setText(dbmschoice[l][1]);
           rdbtn3.setText(dbmschoice[l][2]);
           rdbtn4.setText(dbmschoice[l][3]);
          String uans="";
     ...
     if(rdbtn4.isSelected())
     {
      uans="D";
           ...
           if(uans.equals(dbmsanswer[l]))
                  {
               countdbms++;
               JOptionPane.showMessageDialog(this,"answer is correct ");
           } 
           
           else if(rdbtn1.isSelected() && rdbtn1.getText() != (dbmsanswer[l])
                   || rdbtn2.isSelected() && rdbtn2.getText() != (dbmsanswer[l])
                   || rdbtn3.isSelected() && rdbtn3.getText() != (dbmsanswer[l])
                   || rdbtn4.isSelected() && rdbtn4.getText() != (dbmsanswer[l])){
    ...
    private void btn_NEXTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_NEXTActionPerformed
        ...
        {
             JOptionPane.showMessageDialog(this," Test is over " + " " + " Your Marks Is :" + countdbms + "/10");
             SubjectSelection ss = new SubjectSelection();
             ss.setVisible(true);
        }
