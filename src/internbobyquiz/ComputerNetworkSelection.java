...
import static internbobyquiz.CN.nw;
import static internbobyquiz.CN.nwchoice;
import static internbobyquiz.CN.nwanswer;
 ...
 * @author boby
 */
public class ComputerNetworkSelection extends javax.swing.JFrame {
    int count1=0;
    int countnw=0;
    ...
    public ComputerNetworkSelection() {
        initComponents();
     ...
     public void nw1(int l) {
            
       lbl_Question.setText(nw[l]);
       
           rdbtn1.setText(nwchoice[l][0]);
           rdbtn2.setText(nwchoice[l][1]);
           rdbtn3.setText(nwchoice[l][2]);
           rdbtn4.setText(nwchoice[l][3]);
          String uans="";
     ...
     if(rdbtn4.isSelected())
     {
      uans="D";
           ...
           if(uans.equals(nwanswer[l]))
                  {
               countnw++;
               JOptionPane.showMessageDialog(this,"answer is correct ");
           } 
           
           else if(rdbtn1.isSelected() && rdbtn1.getText() != (nwanswer[l])
                   || rdbtn2.isSelected() && rdbtn2.getText() != (nwanswer[l])
                   || rdbtn3.isSelected() && rdbtn3.getText() != (nwanswer[l])
                   || rdbtn4.isSelected() && rdbtn4.getText() != (nwanswer[l])){
    ...
    private void btn_NEXTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_NEXTActionPerformed
        ...
        {
             JOptionPane.showMessageDialog(this," Test is over " + " " + " Your Marks Is :" + countnw + "/10");
             SubjectSelection ss = new SubjectSelection();
             ss.setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ComputerNetworkSelection.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ComputerNetworkSelection().setVisible(true);
            }
        });
    }
